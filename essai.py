...
browser_socket.listen(10) # TODO il faut attendre qu'il y ait une connction et l'accepter avant de recv
result2 = browser_socket.recv(4096)
print(result2)
